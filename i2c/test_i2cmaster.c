...
#define DEVICEID  0xA2      // device address of EEPROM 24C02, see datasheet
...
int main(void)
{
    ...
    ret = i2c_start(DEVICEID+I2C_WRITE);       // set device address and write mode
    if ( ret ) {
        ...
        i2c_start_wait(DEVICEID+I2C_WRITE);     // set device address and write mode
        i2c_write(0x05);                        // write address = 5
        i2c_rep_start(DEVICEID+I2C_READ);       // set device address and read mode
